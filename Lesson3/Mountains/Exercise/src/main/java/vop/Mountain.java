...
public class Mountain implements Comparable<Mountain> {
    String name;
    int height; //Integer.ParseInt() could've been also used here
    int prominence; //Integer.ParseInt() could've been also used here
    String latitude;
    String longitude;
    String range;
    ...
    public static void main(String[] args) {
        ...
        testArray[0] = new Mountain("Pic du Midi d'Ossau", "2886", "01092", "42\u00B048'22\"", "-00\u00B025'05\"", "Pyrenees");
